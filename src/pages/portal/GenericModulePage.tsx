...
export const GenericModulePage: React.FC<GenericModuleProps> = ({
  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto font-sans">
      {/* Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-5 bg-[#1a251e] border border-white/10 rounded-lg shadow-sm">
        <div>
          ...
          <p className="text-xs text-[#8da394] mt-1">
        ...
        <div className="flex items-center gap-2.5">
          ...
          <FlatButton
            ...
            className="!bg-[#41cc84] hover:!bg-[#36ba76] !text-black !border-transparent text-xs font-bold"
            leftIcon="pi pi-plus"
          >
            Add Record
          </FlatButton>
      ...
      {/* Main Card Surface */}
      <div className="p-10 bg-[#1a251e] border border-white/10 rounded-lg shadow-sm flex flex-col items-center justify-center text-center space-y-4">
        <div className="w-14 h-14 rounded-full bg-[#202d24] border border-white/10 flex items-center justify-center text-[#41cc84] text-xl shadow-inner">
          <i className={icon} />
        </div>
        <div className="space-y-1 max-w-md">
          ...
          <p className="text-xs text-[#8da394] leading-relaxed">
            This module outlet is structured and mounted within the semi-flat dark green layout.
